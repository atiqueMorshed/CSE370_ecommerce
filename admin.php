          ...
          <div class="container-fluid h-100">
            <div class="row justify-content-center align-items-center h-100">
              <div class="col col-sm-6 col-md-6 col-lg-6 col-xl-6" style="background-color: #F7F7F7; padding:20px">
                ...
                <!-- <a href="adminForm.php?id=<?php echo $row['PRE_ID'] ?>" target="_blank" class="site-btn">Edit Details</a> -->
                <a href="adminForm.php?id=<?php echo $row['PRE_ID'] ?>" target="_blank" class="site-btn">Add price and property name</a>
             </div>
           </div>
         </div>
        </section>
