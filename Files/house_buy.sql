...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2019 at 02:36 AM
...
--
-- Indexes for table `preproperty`
--
ALTER TABLE `preproperty`
  ADD PRIMARY KEY (`PRE_ID`,`USERNAME`),
  ADD KEY `USERNAME` (`USERNAME`);
...
--
ALTER TABLE `employee`
  MODIFY `EMP_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10014;

--
-- AUTO_INCREMENT for table `preproperty`
--
ALTER TABLE `preproperty`
  MODIFY `PRE_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
